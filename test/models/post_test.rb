...
class PostTest < ActiveSupport::TestCase
   ...
   test "create_post" do
        post = Post.create(name: 'タイ',number: 2,date: Date.new(2019,04,02),description:'hogehoge',feed:'ゴカイ',weather:'晴れ',address:'兵庫県',size: 30)
