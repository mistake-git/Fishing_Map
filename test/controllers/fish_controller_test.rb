    ...
    #       post fish_index_url, params: { fish: { level: @fish.level, month: @fish.month, name: @fish.name } }
    #     end
    ...
    #     patch fish_url(@fish), params: { fish: { level: @fish.level, month: @fish.month, name: @fish.name } }
